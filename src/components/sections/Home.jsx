...
const Home = () => {
  ...
  return (
    <section id='home' className='min-h-150 flex items-center justify-center relative'>
      ...
      <RevealOnScroll>
        <div className='text-center z-10 px-4'>
            ...
            from-blue-500 to-cyan-400 bg-clip-text text-transparent leading-right'>
                Hi, Am Fidelis Atemie Jumbo
            </h1>

            <p className='text-gray-400 text-lg mb-8 max-w-lg mx-auto'>
             Am frondend web developer who loves making great, responsive web applications.
            </p>
            <div className='flex justify-center space-x-4'>
              ...
              rounded font-medium transition-all duration-200 hover:bg-blue-500/10  
